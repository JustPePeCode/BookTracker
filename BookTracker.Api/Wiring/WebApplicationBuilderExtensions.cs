...
public static class WebApplicationBuilderExtensions
{
    ...
    {
        var handlerTypes = HandlerMarker.Assembly.GetTypes().Where(IsHandler);
    ...
    {
        return type is { IsClass: true, IsAbstract: false } && type.IsAssignableTo(HandlerMarker);
    }
    ...
    {
        var settings =
            builder.Configuration.GetRequiredSection(JwtSettings.SectionName).Get<JwtSettings>()
