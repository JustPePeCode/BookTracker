...
public class GetBookDetailsQueryHandlerTests : IntegrationTest
{
    [Fact]
    public async Task GetBookDetailsQueryHandlerReturnsBook()
    {
        Writer.Seed(db =>
        {
            db.Books.Add(
    ...
    [Fact]
    public async Task GetBookDetailsQueryHandlerReturnsNotFoundWhenBookDoesNotExist()
    {
